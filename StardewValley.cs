...
public class StardewValley : SimpleTCPPack
{
    ...
    public override EffectList Effects => new List<Effect>
    {
            ...
            new("Stone Golem", "spawn_stonegolem") { Category = "Spawn Creature", Quantity = 100},
            ...
            new("Emote Sad", "emote_sad"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Heart", "emote_heart"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Exclamation", "emote_exclamation"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Sleep", "emote_sleep"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Game", "emote_game"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Note", "emote_note"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Question", "emote_question"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote X", "emote_x"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Pause", "emote_pause"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Blush", "emote_blush"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Angry", "emote_angry"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote yes", "emote_yes"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote No", "emote_no"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Sick", "emote_sick"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Laugh", "emote_laugh"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Taunt", "emote_taunt"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Surprised", "emote_surprised"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Hi", "emote_hi"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Uh", "emote_uh"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Play Music", "emote_music"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Open Jar", "emote_jar"){ Category = "Force Emote", Price = 1, Description = "SAD!"},
            new("Emote Happy", "emote_happy"){ Category = "Force Emote", Price = 1, Description = "SAD!"},

            new("Force Divorce Ofcourse", "divorce"){ Category = "Heartbreak", Price = 100000, Description = "Force the player to divorce their spouse if they are married."},
            ...
            new("Remove Swimware", "swimware_off"){ Price = 500, Description = "Removes the players swimware."},
