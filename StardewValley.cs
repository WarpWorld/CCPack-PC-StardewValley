...
public class StardewValley : SimpleTCPPack<SimpleTCPServerConnector>
{
    ...
    public override EffectList Effects { get; } = new List<Effect>
    {
            ...
            new("Adrenaline Rush", "give_buff_adrenaline") { Category = "Status Effects", Duration = 30 },
            new("Darkness", "give_buff_darkness") { Category = "Status Effects", Duration = 30 },
            new("Frozen", "give_buff_frozen") { Category = "Status Effects", Duration = 10 },
            new("Invincibility", "give_buff_invincibility") { Category = "Status Effects", Duration = 30 },
            new("Nauseous", "give_buff_nauseous") { Category = "Status Effects", Duration = 60 },
            new("Slimed effect", "give_buff_slime") { Category = "Status Effects", Duration = 10 },
            new("Speed Buff", "give_buff_speed") { Category = "Status Effects", Duration = 120 },
            new("Tipsy", "give_buff_tipsy") { Category = "Status Effects", Duration = 120 },
            new("Warrior Energy", "give_buff_warrior") { Category = "Status Effects", Duration = 30 },
            ...
            new("Bat", "spawn_bat") { Category = "Spawn Creature", Quantity = 10},
            new("Cave Fly", "spawn_fly") { Category = "Spawn Creature", Quantity = 10},
            new("Frost Bat", "spawn_frostbat") { Category = "Spawn Creature", Quantity = 10},
            new("Ghost", "spawn_ghost") { Category = "Spawn Creature", Quantity = 10},
            new("Lava Bat", "spawn_lavabat") { Category = "Spawn Creature", Quantity = 10},
            new("Serpent", "spawn_serpent") { Category = "Spawn Creature", Quantity = 10},
            new("Green Slime", "spawn_slime") { Category = "Spawn Creature", Quantity = 10},
            new("Red Slime", "spawn_redslime") { Category = "Spawn Creature", Quantity = 10},
            new("Frost Jelly", "spawn_frostjelly") { Category = "Spawn Creature", Quantity = 10},
            new("Red Sludge", "spawn_redsludge") { Category = "Spawn Creature", Quantity = 10},
            new("Blue Squid", "spawn_bluesquid") { Category = "Spawn Creature", Quantity = 10},
            new("Skelton", "spawn_skelton") { Category = "Spawn Creature", Quantity = 10},
            new("Skeleton Mage", "spawn_skeletonmage") { Category = "Spawn Creature", Quantity = 10},


            new("Bug", "spawn_bug") { Category = "Spawn Creature", Quantity = 10},
            new("Wilderness Golem", "spawn_wildernessgolem") { Category = "Spawn Creature", Quantity = 10},
