...
public class StardewValley : SimpleTCPPack
{
    ...
    public override EffectList Effects => new List<Effect>
    {
            ...
            new("Bat", "spawn_bat") { Category = "Spawn Creature"},
            new("Cave Fly", "spawn_fly") { Category = "Spawn Creature"},
            new("Frost Bat", "spawn_frostbat") { Category = "Spawn Creature"},
            new("Ghost", "spawn_ghost") { Category = "Spawn Creature"},
            new("Lava Bat", "spawn_lavabat") { Category = "Spawn Creature"},
            new("Serpent", "spawn_serpent") { Category = "Spawn Creature"},
